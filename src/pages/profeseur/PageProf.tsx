...
const allStudents: Student[] = [
  ...
  { 
    ...
    photo: "/images/me.jpg",
    matieres: [
      { nom: "Mathématiques", note: 18, appreciation: "Excellent" }
    ]
  },
  { 
    id: 3, 
    ...
    photo: "/images/me.jpg",
    matieres: [
      { nom: "Français", note: 14, appreciation: "Très bien" }
    ]
  },
  { 
    id: 4, 
  ...
  { 
    ...
    photo: "/images/me.jpg",
    matieres: [
      { nom: "Mathématiques", note: 10, appreciation: "Passable" }
    ]
  },
];
                  ...
                  >
                    ...
                    <td className="px-4 py-2">
                      <div className="flex flex-col gap-1">
                        {notesMatiere.length > 0 ? (
                          notesMatiere.map((matiere, index) => (
                            <div key={index} className="flex items-center gap-2">
                              <span className="font-medium">{matiere.nom}: {matiere.note}/20</span>
                              <span className="text-sm text-gray-600">({matiere.appreciation})</span>
                            </div>
                          ))
                        ) : (
                        ...
                        <button
                          className="flex items-center gap-1 bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded mt-1 w-fit"
